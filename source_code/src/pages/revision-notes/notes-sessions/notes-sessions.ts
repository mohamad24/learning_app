...
/**
 * Generated class for the NotesSessionsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-notes-sessions',
  templateUrl: 'notes-sessions.html',
})
export class NotesSessionsPage {
  ...
  goToPost(post){
    this.navCtr.push('NotesListPage',{
      post:post
    });
  }
...
private loadPosts(page){
    this.showRetry= false;
     return this.apiService.revisionNotesSessions(page);
}
