...
/**
 * Generated class for the ForumSessionsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-forum-sessions',
  templateUrl: 'forum-sessions.html',
})
export class ForumSessionsPage {
  ...
  goToPost(id,post){
    this.navCtr.push('ForumTopicsPage',{
      id:id,
      post:post
    });
  }
...
private loadPosts(page){
    this.showRetry= false;
     return this.apiService.forumSessions(page);
}
